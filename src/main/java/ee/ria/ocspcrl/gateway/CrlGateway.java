...
public record CrlGateway(RestClient restClient) {
    ...
    private RestClient.RequestHeadersSpec<?> getHeadersSpec(CrlHeaders crlHeaders) {
        ...
        if (crlHeaders == null) return headersSpec;
    ...
    public record CrlHeaders(String lastModified, String eTag) {}

    public interface CrlResponse {}

    public record NewCrlFileResponse(byte[] crl, CrlHeaders crlHeaders) implements CrlResponse {}
