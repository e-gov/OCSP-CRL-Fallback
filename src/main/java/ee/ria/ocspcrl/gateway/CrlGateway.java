...
public record CrlGateway(RestClient restClient) {
    ...
    public CrlResponse downloadFile(@Nullable CrlHeaders crlHeaders) {
        ...
        HttpStatusCode statusCode = response
                .getStatusCode();
        ...
        return new NewCrlFileResponse(response
                .getBody(),
                new CrlHeaders(
    ...
    private RestClient.RequestHeadersSpec<?> getHeadersSpec(CrlHeaders crlHeaders) {
        RestClient.RequestHeadersSpec<?> headersSpec = restClient
                .get();
        if (crlHeaders == null)
            return headersSpec;
        ...
        if (crlHeaders
                .lastModified() != null) {
            headersSpec
                    .header(HttpHeaders.IF_MODIFIED_SINCE, crlHeaders
                            .lastModified());
        }
        if (crlHeaders
                .eTag() != null) {
            headersSpec
                    .header(HttpHeaders.IF_NONE_MATCH, crlHeaders
                            .eTag());
        }
    ...
    public record CrlFileNotModifiedResponse(CrlHeaders crlHeaders) implements CrlResponse {}
}
