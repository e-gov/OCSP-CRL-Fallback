...
public class MockPropertyBeanConfiguration {
    ...
    public GitProperties dummyGitProperties() {
        Properties properties = new Properties();
        properties
                .put("branch", "branch-value");
        properties
                .put("commit.id", "commit.id-value");
        properties
                .put("commit.id.abbrev", "commit.id.abbrev-value");
        properties
                .put("commit.time", "commit.time-value");
