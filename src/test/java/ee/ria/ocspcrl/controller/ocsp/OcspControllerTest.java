...
class OcspControllerTest extends BaseIntegrationTest {
    ...
    private final DigestCalculator digestCalculator = new BcDigestCalculatorProvider().get(
    ...
    private static OcspController ocspController() {
        ...
        CertificateChain certificateChain = new CertificateChain(
            ...
            ISSUER_CERTIFICATE,
            new CrlDownload(URI.create("https://example.org/example.crl").toURL(), Duration.ofMillis(1), "<not-used>")
        );
