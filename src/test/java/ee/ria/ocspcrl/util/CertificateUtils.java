...
public class CertificateUtils {
    ...
    public static void addCertificatesFromSpecifiedTruststoreToDefaultTruststore(
            Path customTruststorePath, String customTruststorePassword) throws Exception {
    ...
    public static PrivateKey loadECPrivateKeyFromClasspath(String path) {
        ...
        Pattern paramsPattern =
                Pattern.compile("-----BEGIN EC PARAMETERS-----(.*?)-----END EC PARAMETERS-----", Pattern.DOTALL);
        ...
        Pattern keyPattern =
                Pattern.compile("-----BEGIN EC PRIVATE KEY-----(.*?)-----END EC PRIVATE KEY-----", Pattern.DOTALL);
